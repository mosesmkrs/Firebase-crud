...
export default function Auth() {
  ...
  return (
    <div className=" min-h-full w-1/3 mx-auto my-[5%] p-5 bg-slate-50 border rounded-md grid">
      ...
      <span>Do you have a Google account? <button className="p-2 w-fit text-center rounded-lg m-2 mx-auto text-blue-500 hover:text-green-500" onClick={SignInWithGoogle}>Sign with google</button>
      </span>
